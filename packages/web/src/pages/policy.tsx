    ...
    <Layout>
      ...
      <Content>
        ...
        <Paragraph>
          ...
          продуктов или услуг «{data.brand}» а также, являющегося стороной по
          гражданско-правовому договору.
        </Paragraph>
        <Paragraph>
          Положение определяет порядок и условия обработки персональных данных
          Оператором - «{data.brand}» и устанавливает порядок работы с
          ...
          и работников компании оператора «{data.brand}».
        </Paragraph>
        <Paragraph>
        ...
        <List>
          ...
          <li>
            ...
            (URL): {data.address}, далее сайт Оператора
          </li>
          <li>
